...
#' @export
run_pmcmc_annual <- function(data_raw=NULL,
                      data_raw_pg=NULL,
                      data_raw_mg=NULL,
                      init_EIR = NULL,
                      target_prev=NULL,
  ...
  data_proc <- data_process_annual(data_raw=data_raw,start_pf_time=start_pf_time,check_flexibility = check_flexibility)
  data <- data_proc$data
    ...
    index <- function(info) {
      list(run = c(prev = info$index$prev),
           state = c(prev_05 = info$index$prev,
                     ...
                     prev_514 = info$index$prev514,
                     prev_15plus = info$index$prev_15plus,
                     prev_15plus = info$index$prev_15plus,
                     prev2.10 = info$index$prev2.10,
                     ...
                     clininc_014 = info$index$inc014,
                     severe_all = info$index$sev_inc_all,  # Add this
                     severe_05 = info$index$sev_inc05,
                     severe_14 = info$index$sev_inc014,
